...
<p>&nbsp;</p>
<form id="form1" name="form1" method="get" action="encontrado.php?$id_accesorio=id_accesorio">
  <label for="id_accesorio" class="ingresar">	Ingresar el ID a Buscar:</label>
